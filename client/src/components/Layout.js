...
function Layout({children}) {
    return (
        <>
            ...
            <div
                className="bg-gray-200 shadow-lg w-full h-20 flex items-center">
                <div className="flex justify-center space-x-10 container">
                    ...
                    <Link href="/frequentQuestions">
                        <a className="font-medium text-gray-700">Preguntas
                            Frecuentes</a>
                    </Link>
                    <div>
                        <Link href="/login">
                            <button
                                className="px-10 py-1 font-normal text-xs rounded-sm shadow-md text-gray-800 bg-white hover:bg-gray-50">
                                Iniciar Sesión
                            </button>
                        </Link>
                    </div>
