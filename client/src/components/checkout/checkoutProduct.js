            ...
            <div className="bg-white h-52 flex items-center rounded-md">
                ...
                <div className="font-deco mx-8">
                    ...
                    <div className="flex items-center font-deco">
                        <button
                            className="h-8 w-8 shadow-md mr-5 text-black text-xl font-bold"> +
                        </button>
                        <div className="text-3xl text-dark">5</div>
                        <button
                            className="h-8 w-8 shadow-md ml-5 text-black text-2xl font-bold"> -
                        </button>
                    </div>
                    <div className="text-2xl pt-2">
                        Precio
                    ...
                    <div className="flex justify-end">
                        <button
                            className="h-8 w-8 shadow-md bg-dark text-pale text-2xl">
                            X
                        </button>
                    </div>
                </div>
