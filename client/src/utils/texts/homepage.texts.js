...
export var sliderTexts = [
    {
        title: 'Artesania Tamashii',
        text: '',
        description: `
            Tamashii Nations is a place for products with tamashii instilled by 
            Japanese master craftsmen. Based in Asakusa, Tokyo, we make 
            fully-assembledfigures for collectors, as a division of 
            Japan's top toymaker, Bandai. 
           `,
    },
    {
        title: 'Escultura:',
...
export var aboutUs = {
    title: 'EL SECRETO ESTÁ EN LOS DETALLES: Esa es el alma de la artesanía TAMASHII.',
    text: `
